...
<div class="md:pr-64 flex flex-col flex-1 h-full print:md:pr-0">
  <div class="sticky top-0 flex justify-end z-10 md:hidden pl-1 pt-1 sm:pl-3 sm:pt-3 bg-gray-100 dark:bg-neutral-950 shadow print:hidden print:md:hidden">
  ...
  <main class="flex-1 flex items-center pt-28 lg:pt-12 print:pt-0 print:lg:pt-0">
    <div class="py-12 w-full print:py-0">
...
<div class="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0 md:right-0 print:hidden print:md:hidden">
