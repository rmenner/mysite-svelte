...
<div class="flex justify-evenly text-gray-700 dark:text-teal-100 mt-5" aria-hidden>
  <button
	class="border-0 border-transparent focus:outline-none rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus-visible:ring-1 focus-visible:ring-offset-2 focus:ring-0 focus-visible:ring-black dark:focus-visible:ring-black"
	class:hidden
	on:click={toggle}
>
	<!-- moon icon -->
	...
	<!-- sun icon -->
	<svg class="h-5 w-5 text-teal-700" class:hidden={dark} viewBox="0 0 20 20" fill="currentColor">
		<path
			fill-rule="evenodd"
